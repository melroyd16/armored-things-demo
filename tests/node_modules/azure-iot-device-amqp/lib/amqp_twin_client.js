...
var AmqpTwinClient = /** @class */ (function (_super) {
    ...
    function AmqpTwinClient(authenticationProvider, client) {
        ...
        _this._messageHandler = function (message) {
            ...
            //
            var correlationId = message.properties ? message.properties.correlationId : undefined;
            if (correlationId) {
                    ...
                    _onEnter: function (attachCallback) {
                        ...
                        _this._authenticationProvider.getDeviceCredentials(function (err, credentials) {
                            if (err) {
                                ...
                                _this._endpoint = azure_iot_common_1.endpoint.devicePath(credentials.deviceId) + '/twin';
    ...
    AmqpTwinClient.prototype._onResponseMessage = function (message) {
        ...
        if (this._pendingTwinRequests[message.properties.correlationId]) {
            var pendingRequestCallback = this._pendingTwinRequests[message.properties.correlationId];
            ...
            if (message.messageAnnotations.status >= 200 && message.messageAnnotations.status <= 300) {
                ...
                var result = message.body ? JSON.parse(message.body) : undefined;
